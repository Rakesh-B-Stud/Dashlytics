...
from components import navbar, kpi, card_start, card_end, page_nav
import streamlit.components.v1 as components
from components import navbar

st.set_page_config(
    page_title="Dashlytics — Welcome",
...
<div class="feature-grid">
    <div class="feature-card">
        ...
        <div class="feature-desc">Automatically detects and fixes missing values, duplicates, and outliers.</div>
    </div>
    <div class="feature-card">
        <div class="feature-icon">📊</div>
        <div class="feature-title">Statistical Analysis</div>
        <div class="feature-desc">Correlation heatmaps, distributions, and descriptive statistics at a glance.</div>
    </div>
    <div class="feature-card">
        <div class="feature-icon">🤖</div>
        <div class="feature-title">3 ML Models</div>
        <div class="feature-desc">KNN, Decision Tree, and Naive Bayes run simultaneously with accuracy benchmarks.</div>
    </div>
    <div class="feature-card">
        <div class="feature-icon">🗂️</div>
        <div class="feature-title">Interactive Dashboard</div>
        <div class="feature-desc">Build custom charts with drag-and-drop column selection across 5 chart types.</div>
    </div>
    <div class="feature-card">
        <div class="feature-icon">📄</div>
        <div class="feature-title">AI Report Generation</div>
        <div class="feature-desc">Download a professional PDF report written by an LLM based on your data.</div>
    </div>
    <div class="feature-card">
        <div class="feature-icon">🕘</div>
        <div class="feature-title">Analysis History</div>
        <div class="feature-desc">Every run is saved automatically so you can track and compare past analyses.</div>
    </div>
</div>
...
kpi("Processing Speed", "Automatic", c1)
kpi("ML Models", "3 Algorithms", c2)
kpi("Chart Types", "5 Options", c3)
...
<div style="text-align:center; padding: 12px 0 8px;">
    <div style="font-size:18px; font-weight:700; color:#E6EDF3; margin-bottom:6px; letter-spacing:-0.025em;">
        Ready to begin?
    </div>
    <div style="font-size:13px; color:#484F58; margin-bottom:20px;">
        Upload your dataset and the pipeline starts automatically.
    </div>
</div>
""", unsafe_allow_html=True)
